...
//        fundList.add("博时黄金ETF");
        ...
        for (String s1 : fundList) {
            FixedInvestment fixedInvestment = getDirectRate(s1, ksrq, jsrq, d);
    ...
    public  static FixedInvestment getDirectRate(String s,Date startDate,Date endDate,Double d) throws Exception {
        //存储每日收益
