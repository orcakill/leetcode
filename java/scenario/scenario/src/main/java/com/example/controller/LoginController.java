...
public class LoginController {
	...
	/***
	 * @description: 判断是否有下载插画
	 * @param downloadIllustration --下载插画
	 * @param donTPrompt --下载
	 * @param download   --确定下载
	 * @return: void
	 * @author: orcakill
	...
	private static void downloadIllustration (String downloadIllustration, String donTPrompt, String download) throws InterruptedException, AWTException {
		boolean boolean_XZCH;
