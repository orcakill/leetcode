...
public interface ImageOpenCVService {
	...
	static String imagesOpenCV (Map<String, String> files, Double coefficient, Integer start_num, Integer end_num)
	...
	static String imagesOpenCV (Map<String, String> files, int identificationAlgorithmType, Double coefficient, Integer start_num,
	                            Integer end_num, int characteristicPoint) throws InterruptedException, AWTException, IOException {
		return imagesOpenCV0 (files, identificationAlgorithmType, "夜神模拟器", 60, start_num, end_num, true, true, coefficient,
		                      characteristicPoint);
	}
	...
	static String imagesOpenCV0 (Map<String, String> files, int identificationAlgorithmType, String process, Integer re_num,
	                             ...
	                             int characteristicPoint) throws InterruptedException, AWTException, IOException {
