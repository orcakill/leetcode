...
public interface ImageOpenCVService {
	...
	static String imagesOpenCV (Map<String, String> files, Double coefficient, Integer start_num, Integer end_num) throws InterruptedException, AWTException, IOException {
		return imagesOpenCV (files, "夜神模拟器", 60, start_num, end_num, true, true, coefficient);
	}
	
	static String imagesOpenCV (Map<String, String> files, String process, Integer re_num, Integer start_time,
	                            Integer end_time, Boolean boole, boolean isClick, Double coefficient) throws
