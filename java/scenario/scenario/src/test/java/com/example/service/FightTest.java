		      ...
		      for(int i=1;i<=2;i++){
				  ...
				  while (reinforcementState){
					  ...
					  if(strengtheningTimes==3){
						  logger.info ("第三次强化，强化+9,4个四星青吉鬼");
						  quantityOfConsumableMaterials=4;
					  }
					  if(strengtheningTimes==4){
						  logger.info ("第四次强化，强化+12,12个四星青吉鬼");
					  ...
					  logger.info ("第strengtheningTimes:{}次,点击quantityOfConsumableMaterials:{}个四星青吉鬼",strengtheningTimes,quantityOfConsumableMaterials);
