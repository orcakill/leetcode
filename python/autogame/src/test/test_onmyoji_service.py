...
class TestOnmyojiService(TestCase):
    ...
    def test_foster_care(self):
        ...
        :return:；
        """
        TestOnmyojiService.test_project('2', '1', "式神寄养")
    ...
    def test_friends_fight(self):
        ...
        :return:
        """
        TestOnmyojiService.test_project('2,3,4,5', '0', "好友协战")
    ...
    def test_soul_fight_eleven(self):
        ...
        :return:
        """
        TestOnmyojiService.test_project('2,3,4,5', '2', "魂十一", fight_times=60)
    ...
    def test_soul_fight_sun(self):
        ...
        :return:
        """
        TestOnmyojiService.test_project('2,3,4,5', '2', "日轮之陨", fight_times=50)
    ...
    def test_explore(self):
        ...
        :return:
        """
        TestOnmyojiService.test_project('1', '1', "探索")
    ...
    def test_project(test_names, test_devices, project_name, fight_times: int = 1, chapter: int = 28,
        ...
        for i in range(len(game_tasks)):
            ...
            elif game_project.project_name in ["当前活动1"]:
                OnmyojiService.current_activity(game_task)
            # 项目 27
