...
class Onmyoji:
    ...
    broder_JJTPTB=r"探索\结界突破\结界突破图标"
    broder_JSTXDH = r"探索\结界突破\角色头像大号"
    broder_JSTXXH = r"探索\结界突破\角色头像小号"
    broder_JG = r"探索\结界突破\进攻"
    broder_TCTZ = r"探索\结界突破\退出挑战"
    broder_SDZR = r"探索\结界突破\锁定阵容"
    # 返回
